...
final class Api_ClientTest extends \BBTestCase
{
    ...
    public function testUpdateNameservers(): void
    {
        ...
        $data = [];
        $result = $clientApiMock->client_update_nameservers($data);
    ...
    public function testUpdateContacts(): void
    {
        ...
        $data = [];
        $result = $clientApiMock->client_update_contacts($data);
    ...
    public function testEnablePrivacyProtection(): void
    {
        ...
        $data = [];
        $result = $clientApiMock->client_enable_privacy_protection($data);
    ...
    public function testDisablePrivacyProtection(): void
    {
        ...
        $data = [];
        $result = $clientApiMock->client_disable_privacy_protection($data);
    ...
    public function testGetTransferCode(): void
    {
        ...
        $data = [];
        $result = $clientApiMock->client_get_transfer_code($data);
    ...
    public function testLock(): void
    {
        ...
        $data = [];
        $result = $clientApiMock->client_lock($data);
    ...
    public function testUnlock(): void
    {
        ...
        $data = [];
        $result = $clientApiMock->client_unlock($data);
    ...
    public function testGetService(): void
    {
        ...
        $result = $this->clientApi->client_lock($data);
