...
{
    /**
     * @var \FOSSBilling\Module\Cart\Api\Guest
     */
    protected $guestApi;

    public function setup(): void
    {
        $this->guestApi = new \FOSSBilling\Module\Cart\Api\Guest();
    }
    ...
    public function testSetCurrency(): void
    {
        ...
        $currencyServiceMock = $this->getMockBuilder('\\' . \FOSSBilling\Module\Currency\Service::class)
    ...
    public function testAddItemSingle(): void
    {
        ...
        $apiMock = $this->getMockBuilder('\\' . \FOSSBilling\Module\Cart\Api\Guest::class)
