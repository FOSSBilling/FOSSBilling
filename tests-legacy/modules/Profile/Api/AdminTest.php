...
class AdminTest extends \BBTestCase
{
    ...
    {
        $service = new \FOSSBilling\Module\Profile\Service();
        ...
        $adminApi = new \FOSSBilling\Module\Profile\Api\Admin();
    ...
    public function testUpdate(): void
    {
        ...
        $serviceMock = $this->getMockBuilder('\\' . \FOSSBilling\Module\Profile\Service::class)
            ->getMock();
