...
{
    /**
     * @var \FOSSBilling\Module\Profile\Api\Client
     */
    protected $clientApi;

    public function setUp(): void
    {
        $this->clientApi = new \FOSSBilling\Module\Profile\Api\Client();
    }
    ...
    {
        $service = $this->getMockBuilder('\\' . \FOSSBilling\Module\Profile\Service::class)->getMock();
