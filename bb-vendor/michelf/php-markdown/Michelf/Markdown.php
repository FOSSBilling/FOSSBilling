...
/**Deprecated: Array and string offset access syntax with curly braces is deprecated in /var/www/vhosts/webbhostingservices.com/httpdocs/boxbilling/src/bb-vendor/michelf/php-markdown/Michelf/Markdown.php**/
		switch ($token(0)) {
			case "\\":
