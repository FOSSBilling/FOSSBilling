...
/**Deprecated: Array and string offset access syntax with curly braces is deprecated in /var/www/vhosts/webbhostingservices.com/httpdocs/boxbilling/src/bb-vendor/michelf/php-markdown/Michelf/MarkdownExtra.php**/
			if ($element(0) == '.') {
