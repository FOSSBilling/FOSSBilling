...
test('parses valid period codes correctly', function (string $code, string $expectedUnit, int $expectedQty, float $expectedDays) {
...
test('contains the quantity in period titles', function () {
...
test('calculates months correctly', function () {
...
test('has expiration time in the future', function () {
    $now = time();
