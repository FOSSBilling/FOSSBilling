...
/**
 * @deprecated This directory contains deprecated legacy tests.
 * New tests should be written in tests/unit/ or tests/integration/.
 *
 * These tests use old patterns including:
 * - Complex mock setups without clear behavior testing
 * - Duplicate test code across methods
 * - Tight coupling to implementation details
 *
 * See tests/library/ for modern test infrastructure.
 */
