...
class Api_AdminTest extends \BBTestCase
{
    ...
    public function testGet()
    {
        ...
        $apiMock = $this->getMockBuilder('\Box\Mod\Order\Api\Admin')->onlyMethods(array('_getOrder'))->disableOriginalConstructor()->getMock();
    ...
    public function testRenewPendingSetup()
    {
        ...
        $apiMock = $this->getMockBuilder('\Box\Mod\Order\Api\Admin')->onlyMethods(array('_getOrder', 'activate'))->disableOriginalConstructor()->getMock();
        $apiMock->expects($this->atLeastOnce())
            ->method('_getOrder')
            ->will($this->returnValue($order));
        $apiMock->expects($this->atLeastOnce())
    ...
    {
        $activityMock = $this->getMockBuilder('\Box\Mod\Order\Api\Admin')->onlyMethods(array('delete'))->getMock();
