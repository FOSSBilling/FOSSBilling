...
final class AdminTest extends TestCase
{
    ...
    public function testInvalidThemeActionReturnsError(): void
    {
        ...
        $this->assertMatchesRegularExpression('/(?:non[_\\s-]?existing[_\\s-]?action|non\\W*existing\\W*action)/i', $errorMessage, 'Error message should reference the invalid action or endpoint.');
    }
}
