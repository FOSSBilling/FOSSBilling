...
RUN set -eux; \
  ...
  php -r '$class = "FOSSBilling\\Core\\Cache\\CacheFactory"; require "./src/vendor/autoload.php"; if (!class_exists($class)) { fwrite(STDERR, "Release Composer autoloader is missing {$class}.\n"); exit(1); }'; \
