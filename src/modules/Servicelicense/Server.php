...
class Server implements \FOSSBilling\Core\Container\InjectionAwareInterface
{
    ...
    public function process($data): array
    {
        ...
        $model = $this->di['em']->getRepository(ServiceLicense::class)->findByLicenseKey($data['license']);
