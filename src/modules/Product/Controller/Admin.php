...
class Admin implements \FOSSBilling\Core\Container\InjectionAwareInterface
{
    ...
    public function get_addons(\FOSSBilling\Core\Http\App $app): string
    {
        $this->di['is_admin_logged'];
    ...
    public function get_addon_manage(\FOSSBilling\Core\Http\App $app, $id): string
    {
    ...
    public function get_cat_manage(\FOSSBilling\Core\Http\App $app, $id): string
    {
        $api = $this->di['api_admin'];
    ...
    public function get_promo(\FOSSBilling\Core\Http\App $app, $id): string
    {
        $api = $this->di['api_admin'];
    ...
    public function get_promos(\FOSSBilling\Core\Http\App $app): string
    {
        $this->di['is_admin_logged'];
