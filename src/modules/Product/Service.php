...
class Service implements InjectionAwareInterface
{
    ...
    public function toPromoApiArray(\Model_Promo $model, $deep = false, $identity = null)
    {
        ...
        $result['products'] = $model->products ? json_decode($model->products, true) : null;
        $result['periods'] = $model->periods ? json_decode($model->periods, true) : null;
        $result['client_groups'] = $model->client_groups ? json_decode($model->client_groups, true) : null;
