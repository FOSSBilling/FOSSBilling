...
class PromoRedemption implements ArrayInterface, TimestampInterface
{
    ...
    #[ORM\JoinColumn(name: 'promo_id', referencedColumnName: 'id', nullable: true)]
    private ?Promo $promo = null;

    #[ORM\Column(name: 'client_id', type: \Doctrine\DBAL\Types\Types::BIGINT, nullable: true)]
    private ?int $clientId = null;

    #[ORM\Column(name: 'client_order_id', type: \Doctrine\DBAL\Types\Types::BIGINT, nullable: true)]
