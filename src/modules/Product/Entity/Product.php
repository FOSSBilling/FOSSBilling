...
class Product implements TimestampInterface
{
    ...
    #[ORM\ManyToOne(targetEntity: ProductPayment::class)]
    #[ORM\JoinColumn(name: 'product_payment_id', referencedColumnName: 'id', nullable: true)]
    private ?ProductPayment $productPayment = null;
