...
class Client extends \FOSSBilling\Api\AbstractApi
{
    ...
    private function getClientId(ClientEntity|\Model_Admin|\Model_Client|\FOSSBilling\Identity\Guest $identity): int
    {
    ...
    private function findOrderForIdentity(ClientEntity|\Model_Admin|\Model_Client|\FOSSBilling\Identity\Guest $identity, int $id): ?Order
    {
        if ($identity instanceof ClientEntity) {
