...
class Client implements \FOSSBilling\Container\InjectionAwareInterface
{
    ...
    public function get_products(\FOSSBilling\Http\App $app): string
    {
        return $app->render('mod_order_index');
    }

    public function get_configure_product_by_slug(\FOSSBilling\Http\App $app, $slug): string
    {
    ...
    public function get_configure_product(\FOSSBilling\Http\App $app, $id): string
    {
        $api = $this->di['api_guest'];
    ...
    public function get_orders(\FOSSBilling\Http\App $app): string
    {
    ...
    public function get_order(\FOSSBilling\Http\App $app, $id): string
    {
