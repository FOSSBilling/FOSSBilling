...
class Admin implements \FOSSBilling\Container\InjectionAwareInterface
{
    ...
    public function get_download(\FOSSBilling\Http\App $app, $id, $fileId): Response
    {
    ...
    public function get_order_download(\FOSSBilling\Http\App $app, $orderId, $fileId): Response
    {
        $this->di['is_admin_logged'];
