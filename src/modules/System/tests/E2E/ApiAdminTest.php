...
test('clear cache', function (): void {
...
test('error reporting toggle', function (): void {
...
test('get and set network interfaces', function (): void {
...
test('interface is ignored when not valid', function (): void {
...
test('custom interface', function (): void {
