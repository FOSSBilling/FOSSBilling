...
test('stores setting values and preserves an existing creation timestamp', function (): void {
    $createdAt = new DateTime('2026-01-01 12:00:00');
    $setting = new Setting();
    $setting->setParam('company_name');
    $setting->setValue('Example Ltd');
    $setting->setPublic(true);
    $setting->setCategory('company');
    $setting->setHash('configuration');
