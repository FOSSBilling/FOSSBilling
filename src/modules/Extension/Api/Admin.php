...
class Admin extends \FOSSBilling\Api\AbstractApi
{
    ...
    public function toggle_language(array $data): bool
    {
        ...
        return \FOSSBilling\I18n\I18n::toggleLocale($data['locale_id']);
    }
    ...
    public function locale_completion(array $data): int
    {
        ...
        return \FOSSBilling\I18n\I18n::getLocaleCompletionPercent($data['locale_id']);
    }
    ...
    private function _getExtension($data)
    {
        ...
        if (!$ext instanceof Extension) {
            throw new \FOSSBilling\Exception\InformationException('Extension not found');
        }
