...
class KbArticle implements ApiArrayInterface, TimestampInterface
{
    ...
    public function toApiArray(\Model_Admin|\Model_Client|\FOSSBilling\Identity\Guest|null $identity = null, bool $includeContent = false, bool $includeViews = true): array
    {
