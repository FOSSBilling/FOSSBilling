...
class KbArticle implements ApiArrayInterface, TimestampInterface
{
    ...
    public function toApiArray(\Model_Client|\Box\Mod\Staff\Entity\Admin|\FOSSBilling\Identity\Guest|null $identity = null, bool $includeContent = false, bool $includeViews = true): array
    {
