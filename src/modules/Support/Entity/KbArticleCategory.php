...
class KbArticleCategory implements ApiArrayInterface, TimestampInterface
{
    ...
    public function toApiArray(\Model_Admin|\Model_Client|\FOSSBilling\Identity\Guest|null $identity = null, ?string $query = null, bool $includeArticleViews = true): array
    {
        $data = [
            'id' => $this->id,
            'title' => $this->title,
