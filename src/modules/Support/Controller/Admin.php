...
class Admin implements \FOSSBilling\Container\InjectionAwareInterface
{
    ...
    public function get_ticket(\FOSSBilling\Http\App $app, $id, $messageid = ''): string
    {
    ...
    public function get_helpdesk(\FOSSBilling\Http\App $app, $id): string
    {
        $api = $this->di['api_admin'];
    ...
    public function get_helpdesks(\FOSSBilling\Http\App $app): string
    {
        $this->di['is_admin_logged'];
    ...
    public function get_canned_list(\FOSSBilling\Http\App $app): string
    {
        $this->di['is_admin_logged'];
    ...
    public function get_canned(\FOSSBilling\Http\App $app, $id): string
    {
        $api = $this->di['api_admin'];
    ...
    public function get_canned_cat(\FOSSBilling\Http\App $app, $id): string
    {
        $api = $this->di['api_admin'];
    ...
    */
    public function get_kb_index(\FOSSBilling\Http\App $app): string
    {
        $this->di['is_admin_logged'];
    ...
    public function get_kb_article(\FOSSBilling\Http\App $app, $id): string
    {
        $api = $this->di['api_admin'];
    ...
    public function get_kb_category(\FOSSBilling\Http\App $app, $id): string
    {
        $api = $this->di['api_admin'];
