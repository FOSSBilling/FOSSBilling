...
class Client implements \FOSSBilling\Container\InjectionAwareInterface
{
    ...
    public function get_tickets(\FOSSBilling\Http\App $app): string
    {
    ...
    public function get_ticket(\FOSSBilling\Http\App $app, $id): string
    {
        $id = (string) $id;
    ...
    public function get_contact_us(\FOSSBilling\Http\App $app): string|Response
    {
     ...
     */
    public function get_ticket_redirect(\FOSSBilling\Http\App $app, $hash): Response
    {
    ...
    */
    ...
    public function get_kb_category(\FOSSBilling\Http\App $app, $category): string
    {
    ...
    public function get_kb_article(\FOSSBilling\Http\App $app, $category, $slug): string
    {
        $api = $this->di['api_guest'];
        $data = ['slug' => $slug];
