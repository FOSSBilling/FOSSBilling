...
test('stores values and initializes its timestamp', function (): void {
    $activity = new ActivitySystem();
    $activity->setPriority(5);
    $activity->setAdminId(2);
    $activity->setClientId(3);
    $activity->setMessage('Test event');
    $activity->setIp('192.0.2.3');
