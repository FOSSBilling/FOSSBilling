...
class Service implements InjectionAwareInterface
{
    ...
    private function getPdfCss(): string
    {
        ...
        if ($this->filesystem->exists(Path::join($basePath, 'custom-pdf.css'))) {
            $CSS = $this->filesystem->readFile(Path::join($basePath, 'custom-pdf.css'));
        } else {
            $CSS = $this->filesystem->readFile(Path::join($basePath, 'default-pdf.css'));
        }
