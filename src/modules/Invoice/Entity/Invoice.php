...
class Invoice
{
    ...
    public function setCredit(string|int|float|null $credit): void
    {
    ...
    public function setBaseIncome(string|int|float|null $baseIncome): void
    {
    ...
    public function setBaseRefund(string|int|float|null $baseRefund): void
    {
    ...
    public function setRefund(string|int|float|null $refund): void
    {
