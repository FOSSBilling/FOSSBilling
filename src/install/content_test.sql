...
VALUES
	(1,'admin',1,'admin@boxbilling.com','89e495e7941cf9e40e6980d14a16bf023ccd4c91',NULL,'Demo Administrator','Sincerely Yours, Demo Administrator',1,'active','644846a924e9f4ca76f04f39b3f9c8ac',NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
...
VALUES
	(1,1,NULL,NULL,1000.00,'Christmas Gift','2012-01-01 12:00:00','2012-01-01 12:00:00');
...
VALUES
	...
	(2,'Euro','EUR',0,0.600000,'€{{price}}','1','2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(3,'Pound Sterling','GBP',0,0.600000,'{{price}} ₤','1','2012-01-01 12:00:00','2012-01-01 12:00:00');
...
VALUES
	(1,'Hosting','{\"type\":\"horizontal\", \"show_title\":0}','2012-01-01 12:00:00','2012-01-01 12:00:00');
...
VALUES
	(1,1,'tekstas1','Tekstas1',0,'This is description','text','Thi is default value',1,0,0,NULL,'@','.00$',NULL,NULL,NULL,NULL,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(2,1,'tekstas2','Tekstas2',0,'This is description','checkbox','{\"first checkbox\":\"0\", \"third checkbox\":\"3\"}',1,0,0,NULL,'@','.00$','{\"first checkbox\":\"0\", \"second checkbox\": \"1\", \"third checkbox\":\"3\", \"fourth checkbox\":\"4\"}',NULL,NULL,NULL,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(3,1,'tekstas3','Tekstas3',0,'This is description','radio','1',1,0,0,NULL,'@','.00$','{\"first radio\":\"0\", \"second radio\": \"1\", \"third radio\":\"0\"}',NULL,NULL,NULL,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(4,1,'tekstas5','Tekstas5',0,'This is description','select','3',1,0,0,NULL,'@','.00$','{\"first select\":1, \"second select\":\"2\",\"third\": \"3\"}',NULL,NULL,NULL,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(5,1,'tekstas4','Tekstas4',0,'This is description','textarea','Thi is default value',1,0,0,NULL,'@','.00$','{\"height\":\"100\", \"width\": \"300\"}',NULL,NULL,NULL,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(6,1,'tekstas6','Tekstas6',0,'This is description','textarea','Thi is default value',1,0,0,NULL,'@','.00$','{\"height\":\"50\", \"width\": \"500\"}',NULL,NULL,NULL,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00');
...
VALUES
	(1,'General','Discussions Rules','Rules about discussions','forum-rules','active',1,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(2,'General','General Discussions','Discuss about everything','discuss-about-everything','active',2,'2012-01-01 12:00:00','2012-01-01 12:00:00');
...
VALUES
	(1,1,'What about Installation','what-about-installation','active',0,2,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(2,1,'Read before posting','read-before-posting','active',0,3,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(3,2,'How to install BoxBilling','how-to-install-boxbilling','active',0,20,'2012-01-01 12:00:00','2012-01-01 12:00:00');
...
VALUES
	(1,1,1,NULL,'Its is cool',NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(2,1,1,NULL,'Some other message',NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(3,2,1,NULL,'Some other message',NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(4,3,2,NULL,'I have some question on how to install BoxBilling?',NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00');
...
VALUES
	(1,1,0,'Do you offer free trial','Yes we do\n','do-you-offer-free-trial','active','2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(2,1,0,'Do you offer recurent payments','Yes we do\n','do-you-offer-recurent-payments','active','2012-01-01 12:00:00','2012-01-01 12:00:00'),
...
VALUES
	...
	(4,1,'About us','Now is the time for all good men to come to\nthe aid of their country. This is just a\nregular paragraph.\n\nThe quick brown fox jumped over the lazy\ndog\'s back.\n\n\n> This is a blockquote.\n>\n> This is the second paragraph in the blockquote.\n','about-us','active',NULL,NULL,NULL,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(5,1,'Unfinished news item','the text is yet to be written\n','to-do','draft',NULL,NULL,NULL,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00');
...
VALUES
	(1,4,1,1,'SSL Certificate','ssl-certificate','SSL cetificate information','product',1,'enabled',0,0,'after_payment','[4,5,6]',NULL,0,0,0,NULL,NULL,NULL,100,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00','custom'),
	(2,4,2,NULL,'Custom product with plugin','custom-product','Default product description','product',1,'enabled',0,0,'after_payment','[4,5,6]',NULL,0,0,0,'Plugin_Demo',NULL,NULL,90,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00','custom'),
	(3,4,3,NULL,'Samsung tv set','samsung-tv-set','Default product description','product',1,'enabled',0,0,'after_payment',NULL,NULL,1,1,10,NULL,NULL,NULL,80,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00','custom'),
	(4,4,4,NULL,'Free Addon',NULL,'Sold only as an addon','product',1,'enabled',0,1,'after_payment',NULL,NULL,0,0,0,NULL,NULL,NULL,110,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00','custom'),
	(5,4,5,NULL,'One time payment Addon',NULL,'Sold only as an addon','product',1,'enabled',0,1,'after_payment',NULL,NULL,0,0,0,NULL,NULL,NULL,110,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00','custom'),
	(6,4,6,NULL,'Recurrent payment addon',NULL,'Addon support description','product',1,'enabled',0,1,'after_payment',NULL,NULL,0,0,0,NULL,NULL,NULL,120,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00','custom'),
	(7,3,7,NULL,'BoxBilling license','boxbilling-license','BoxBilling license','product',1,'enabled',0,0,'after_payment','[4,5,6]',NULL,0,0,0,NULL,NULL,NULL,70,'{\"prefix\":\"BOX-PRO-\", \"length\":25, \"plugin\":\"Default\"}','2012-01-01 12:00:00','2012-01-01 12:00:00','license'),
	(8,3,8,NULL,'Free BoxBilling license','free-license','Free BoxBilling license','product',1,'enabled',0,0,'after_order','[4,5,6]',NULL,0,0,0,NULL,NULL,NULL,70,'{\"prefix\":\"BOX-FREE-\", \"length\":25, \"plugin\":\"Default\"}','2012-01-01 12:00:00','2012-01-01 12:00:00','license'),
	(9,1,9,NULL,'My Demo software','boxbilling-software','My Demo software description','product',1,'enabled',0,0,'after_payment','[4,5,6]',NULL,0,0,0,NULL,NULL,NULL,60,'{\"filename\":\"test.txt\"}','2012-01-01 12:00:00','2012-01-01 12:00:00','downloadable'),
	(10,2,10,NULL,'Shared Hosting','shared-hosting','Shared hosting description','product',1,'enabled',0,0,'after_payment','[4,5,6]',NULL,0,0,0,NULL,NULL,NULL,2,'{\"server_id\":\"1\", \"hosting_plan_id\":\"1\", \"reseller\":0,\"free_domain_periods\":[\"3M\"],\"free_domain\":\"1\",\"free_tlds\":[\".com\"]}','2012-01-01 12:00:00','2012-01-01 12:00:00','hosting'),
	(11,2,11,NULL,'Gold Hosting','reseller-hosting','Reseller hosting description','product',1,'enabled',0,0,'after_payment','[4,5,6]',NULL,0,0,0,NULL,NULL,NULL,3,'{\"server_id\":\"1\", \"hosting_plan_id\":\"1\", \"reseller\":1}','2012-01-01 12:00:00','2012-01-01 12:00:00','hosting'),
	(12,5,NULL,NULL,'All domains','domain-checker','Choose domains','product',1,'enabled',0,0,'after_payment','[4,5,6]',NULL,0,0,0,NULL,NULL,NULL,1,'{\"all_tlds\":1}','2012-01-01 12:00:00','2012-01-01 12:00:00','domain'),
	(13,4,12,NULL,'Forum membership','forum-membership','Register for our forum membership','product',1,'enabled',0,0,'after_payment',NULL,NULL,0,0,0,NULL,NULL,NULL,10,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00','membership');
...
VALUES
	(1,'PERCENT',NULL,'percentage',50.00,100,0,0,0,0,1,'[7]',NULL,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(2,'CHRISTMAS',NULL,'percentage',100.00,100,0,1,0,0,1,'[7]',NULL,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(3,'FREESETUP',NULL,'absolute',0.00,100,0,1,0,0,1,'[]',NULL,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(4,'NEW_YEAR',NULL,'absolute',0.00,100,0,1,0,0,1,'[]',NULL,'2012-01-01 12:00:00','2015-01-01 12:00:00','2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(5,'ONCE_PER_CLIENT',NULL,'percentage',100.00,100,0,1,1,0,1,'[]',NULL,'2012-01-01 12:00:00','2015-01-01 12:00:00','2012-01-01 12:00:00','2012-01-01 12:00:00');
...
VALUES
	(1,'Silver','1024','1024',NULL,NULL,NULL,NULL,NULL,'1','{\"custom\":\"value\"}','2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(2,'Golden','2048','2048',NULL,NULL,NULL,NULL,NULL,'2','{\"custom\":\"value\"}','2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(3,'Platinum','4096','4096',NULL,NULL,NULL,NULL,NULL,'5','{\"custom\":\"value\"}','2012-01-01 12:00:00','2012-01-01 12:00:00');
...
VALUES
	(1,'Buffalo','184.22.222.135','server1.main-hosting.com',NULL,NULL,1,1000,'ns1.ilife.lt','ns2.ilife.lt',NULL,NULL,'custom',NULL,NULL,NULL,NULL,NULL,1,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(2,'Server2','184.22.222.139','server2.main-hosting.com',NULL,NULL,1,1000,'ns1.ilife.lt','ns2.ilife.lt',NULL,NULL,'custom',NULL,NULL,NULL,NULL,NULL,1,'2012-01-01 12:00:00','2012-01-01 12:00:00');
...
VALUES
	(1,'last_patch','9',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(2,'company_name','Demo BoxBilling.com',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(3,'company_email','my@mycompany.com',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	...
	(5,'company_logo','/bb-themes/boxbilling/assets/images/logo.png',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	...
	(13,'invoice_starting_number','1',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(14,'invoice_series','BOX',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(15,'invoice_due_days','1',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(16,'invoice_auto_approval','1',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(17,'invoice_issue_days_before_expire','14',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(18,'invoice_refund_logic','credit_note',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(19,'invoice_cn_series','CN-',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	...
	(27,'nameserver_2','ns2.1freehosting.com',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(28,'nameserver_3','ns3.1freehosting.com',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(29,'nameserver_4','ns4.1freehosting.com',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(30,'funds_min_amount','10',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(31,'funds_max_amount','200',0,NULL,NULL,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
...
VALUES
	(1,1,1,100,'Regarding your new domain','closed',NULL,NULL,NULL,NULL,NULL,'2012-01-01 12:00:00','2014-09-16T06:33:41-04:00');
...
VALUES
	(1,NULL,'Global Tax',NULL,NULL,'5','2012-01-01 12:00:00','2012-01-01 12:00:00');
...
VALUES
	(1,1,'.com',11.99,10.99,9.99,1,1,1,1,'2012-01-01 12:00:00','2012-01-01 12:00:00'),
	(2,1,'.net',7.99,7.99,5.99,1,1,1,1,'2012-01-01 12:00:00','2012-01-01 12:00:00');
