...
VALUES
	...
	(2,2,0,'How to place a new order','To place a new order, follow these steps:\n------------------------------------------------------------\n\n* Select our services at the *Order* page.\n* Depending on your selected product, you might need to provide additional information to complete the order request.\n* Click \"Continue\". Your product/service will now be in the shopping cart.\n* If you have a promo code, you can apply it and get a discount.\n* Click on \"Checkout\" button to proceed with the checkout process\n    * If you are already logged in, you will be automaticaly redirected to the new invoice.\n    * If you are a registerd client but not logged in, you can provide your login details.\n    * If you have never purchased any service from us, fill out the client sign up form and then continue the checkout process.\n* Choose your preferred payment method. A list of all avalable payment methods will be listed below the invoice details.\n* You will be redirected to the payment page, through which you can pay for the services you have ordered. \n* After successful payment, you will be redirected back to the invoice page.\n* Depending on selected services your order may be reviewed and activated by our staff members, otherwise it will be activated automatically.\n* You will receive a confirmation email once your order is active, at which time you will be able to login and manage your services.\n','how-to-place-new-order','active','2022-12-01 12:00:00','2022-12-01 12:00:00'),
