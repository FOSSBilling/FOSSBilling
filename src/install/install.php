...
define('PATH_ROOT', Path::join(__DIR__, '..'));
define('PATH_LIBRARY', Path::join(PATH_ROOT, 'library'));
define('PATH_VENDOR', Path::join(PATH_ROOT, 'vendor'));
...
// Load autoloader
require Path::join(PATH_VENDOR, 'autoload.php');
include Path::join(PATH_LIBRARY, 'FOSSBilling', 'Autoloader.php');
