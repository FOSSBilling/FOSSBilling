/**
 * Huraga theme TomSelect setup - only includes language selector functionality
 */
...
document.addEventListener('DOMContentLoaded', () => {
  /**
   * Locale Selector - Huraga specific implementation
   */
  ...
  /**
   * Simple cookie utilities for language selector
   */
