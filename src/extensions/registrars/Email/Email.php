...
class Email extends \FOSSBilling\Extension\Contract\Registrar\AdapterAbstract
{
    ...
    public function transferDomain(\FOSSBilling\Extension\Contract\Registrar\Domain $domain)
    {
        $params = [];
    ...
    public function deleteDomain(\FOSSBilling\Extension\Contract\Registrar\Domain $domain)
    {
        $params = [];
    ...
    public function renewDomain(\FOSSBilling\Extension\Contract\Registrar\Domain $domain)
    {
        $params = [];
    ...
    public function modifyContact(\FOSSBilling\Extension\Contract\Registrar\Domain $domain)
    {
        $params = [];
    ...
    public function lock(\FOSSBilling\Extension\Contract\Registrar\Domain $domain)
    {
        $params = [];
    ...
    public function unlock(\FOSSBilling\Extension\Contract\Registrar\Domain $domain)
    {
        $params = [];
    ...
    private function sendEmail(\FOSSBilling\Extension\Contract\Registrar\Domain $domain, array $params): bool
    {
        $c = $params['content'];
        $c .= PHP_EOL;
        $c .= PHP_EOL;
