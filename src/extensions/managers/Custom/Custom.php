...
namespace FOSSBilling\Extension\Manager\Custom;

class Custom extends \FOSSBilling\Extension\Contract\Server\Manager
{
    /**
     ...
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account|null $account the account for which the URL is generated
     *
