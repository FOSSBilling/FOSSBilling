...
namespace FOSSBilling\Extension\Manager\Plesk;
 ...
 */
class Plesk extends \FOSSBilling\Extension\Contract\Server\Manager
{
     ...
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account|null $account the account for which the login URL should be retrieved
     *
     ...
     *
     * @throws \FOSSBilling\Extension\Contract\Server\Exception if the connection to the Plesk server fails
     */
    public function testConnection(): bool
    {
        ...
        if ($stats->other->uptime < 0) {
            throw new \FOSSBilling\Extension\Contract\Server\Exception('Failed to connect to the :type: server. Please verify your credentials and configuration', [':type:' => 'Plesk']);
        }
     ...
     *
     * @throws \FOSSBilling\Extension\Contract\Server\Exception always throws an exception
     */
    public function synchronizeAccount(\FOSSBilling\Extension\Contract\Server\Account $account): never
    {
        throw new \FOSSBilling\Extension\Contract\Server\Exception(':type: does not support :action:', [':type:' => 'Plesk', ':action:' => __trans('account synchronization')]);
    }
     ...
     *
     * @throws \FOSSBilling\Extension\Contract\Server\Exception if the client creation fails
     */
    public function createAccount(\FOSSBilling\Extension\Contract\Server\Account $account): bool
    {
        ...
        if ($account->getReseller()) {
            ...
            if (count($ips['exclusive']) == 0) {
                ...
                // throw new \FOSSBilling\Extension\Contract\Server\Exception('Out of free IP addresses');
            }
            */
     ...
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account $account the account for which the subscription should be set
     */
    public function setSubscription(\FOSSBilling\Extension\Contract\Server\Account $account): void
    {
     ...
     */
    public function suspendAccount(\FOSSBilling\Extension\Contract\Server\Account $account, bool $suspend = true): bool
    {
     ...
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account $account the account for which the package should be changed
     ...
     *
     * @throws \FOSSBilling\Extension\Contract\Server\Exception if the client modification fails
     */
    public function changeAccountPackage(\FOSSBilling\Extension\Contract\Server\Account $account, \FOSSBilling\Extension\Contract\Server\Package $package): bool
    {
        ...
        if (!$result) {
            throw new \FOSSBilling\Extension\Contract\Server\Exception('Can\'t modify client');
        }
     ...
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account $account the account for which the subscription should be updated
     */
    public function updateSubscription(\FOSSBilling\Extension\Contract\Server\Account $account): void
    {
     ...
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account $account     the account for which the password should be changed
     ...
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account $account     the account for which the username should be changed
    ...
    {
        throw new \FOSSBilling\Extension\Contract\Server\Exception(':type: does not support :action:', [':type:' => 'Plesk', ':action:' => __trans('username changes')]);
    }
     ...
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account $account   the account for which the domain should be changed
     * @param string                                         $newDomain the new domain
     *
     * @return bool the result of the API request to change the domain
     */
    public function changeAccountDomain(\FOSSBilling\Extension\Contract\Server\Account $account, string $newDomain): bool
    {
     ...
     * This is not implemented for Plesk.
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account $account the account for which the IP should be changed
    ...
    {
        throw new \FOSSBilling\Extension\Contract\Server\Exception(':type: does not support :action:', [':type:' => 'Plesk', ':action:' => __trans('changing the account IP')]);
    }
     ...
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account $account the account for which the subscription should be deleted
     *
     * @return mixed the result of the API request to delete the webspace
     */
    public function deleteSubscription(\FOSSBilling\Extension\Contract\Server\Account $account): mixed
    {
     ...
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account $account the account for which the client should be created
     *
     * @return bool returns true after the client has been created
     */
    private function createClient(\FOSSBilling\Extension\Contract\Server\Account $account): bool
    {
     ...
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account $account the account for which the properties should be created
     * @param string                                         $action  the action to be performed on the subscription
     *
     * @return array the array of subscription properties
     */
    private function createSubscriptionProps(\FOSSBilling\Extension\Contract\Server\Account $account, string $action): array
    {
     ...
     *
     * @param \FOSSBilling\Extension\Contract\Server\Account $account the account for which the properties should be modified
     *
     * @return mixed the result of the API request to modify the client's properties
     */
    private function modifyClient(\FOSSBilling\Extension\Contract\Server\Account $account): mixed
    {
     ...
     */
    private function createClientProps(\FOSSBilling\Extension\Contract\Server\Account $account): array
    {
        $client = $account->getClient();
