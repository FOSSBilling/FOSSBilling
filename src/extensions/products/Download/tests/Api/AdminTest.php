...
namespace FOSSBilling\ProductType\Download\Tests\Api;
...
final class AdminTest extends \BBTestCase
{
    ...
    public function testUpdate(): void
    {
        ...
        $modelDownloadableModel = new Download(1);
    ...
    public function testConfigSave(): void
    {
        ...
        $result = $this->api->admin_config_save($data);
        $this->assertIsBool($result);
        $this->assertTrue($result);
    }
    ...
    public function testConfigSaveProductNotFound(): void
    {
        ...
        $this->api->admin_config_save($data);
    }
    ...
    public function testSendFile(): void
    {
        ...
        $result = $this->api->admin_send_file($data);
        $this->assertIsBool($result);
        $this->assertTrue($result);
    }
}
