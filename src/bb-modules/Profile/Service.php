...
class Service implements InjectionAwareInterface
{
    ...
    public function updateClient(\Model_Client $client, array $data = array())
    {
        ...
        $birthday = $this->di['api_request_data']->get('birthday', '');
        ...
        $client->custom_1  = $this->di['api_request_data']->get('custom_1', $client->custom_1);
        $client->custom_2  = $this->di['api_request_data']->get('custom_2', $client->custom_2);
        $client->custom_3  = $this->di['api_request_data']->get('custom_3', $client->custom_3);
        $client->custom_4  = $this->di['api_request_data']->get('custom_4', $client->custom_4);
        $client->custom_5  = $this->di['api_request_data']->get('custom_5', $client->custom_5);
        $client->custom_6  = $this->di['api_request_data']->get('custom_6', $client->custom_6);
        $client->custom_7  = $this->di['api_request_data']->get('custom_7', $client->custom_7);
        $client->custom_8  = $this->di['api_request_data']->get('custom_8', $client->custom_8);
        $client->custom_9  = $this->di['api_request_data']->get('custom_9', $client->custom_9);
        $client->custom_10 = $this->di['api_request_data']->get('custom_10', $client->custom_10);
