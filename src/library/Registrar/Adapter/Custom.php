    ...
    public static function getServers()
    {
        ...
        **/
        $servers=array(
                ...
                //array("ac.jp","whois.nic.ad.jp","No match"), // Does not support domains
                array("ac.uk","whois.ja.net","No such domain"),
                //array("ad.jp","whois.nic.ad.jp","No match"), // Does not support domains
                ...
                array("au","whois.aunic.net","NOT FOUND"),
                array("art.br","whois.nic.br","No match"),
                array("as","whois.nic.as","Domain Not Found"),
                array("asia","whois.nic.asia","NOT FOUND"),
                array("asn.au","whois.aunic.net","NOT FOUND"), // ANS numbers only
                array("ato.br","whois.nic.br","No match"),
                array("av.tr","whois.nic.tr","No match found"),
                array("az","whois.ripe.net","no entries found"),
                array("ba","nic.ba","Naziv domena je slobodan"),
                array("be","whois.geektools.com","AVAILABLE"),
                array("bg","whois.register.bg","available"),
                array("bio.br","whois.nic.br","No match"),
                array("biz","whois.biz","No Data Found"),
                array("biz.tr","whois.nic.tr","No match found"),
                array("bj.cn","whois.cnnic.net.cn","No matching record"),
                array("bel.tr","whois.nic.tr","No match found "),
                array("bmd.br","whois.nic.br","No match"),
                array("br","whois.registro.br","No match"),
                array("by","whois.ripe.net","no entries found"),
                array("ca","whois.cira.ca","available"),
                array("cc","whois.nic.cc","No match"),
                array("cd","whois.nic.cd","No Object "),
                array("cf","whois.dot.cf","not known"),
                array("ch","whois.nic.ch","not registered."),
                array("cim.br","whois.nic.br","No match"),
                //array("ck","whois.nic.ck","No entries found"), not available
                array("cl","whois.nic.cl","no entries found"),
                array("cn","whois.cnnic.net.cn","No entries found"),
                array("cng.br","whois.nic.br","No match"),
                array("cnt.br","whois.nic.br","No match"),
                array("com","whois.verisign-grs.com","NOT FOUND"),
                ...
                array("ga","whois.dot.ga","Invalid query"),
                ...
                array("gq","whois.dominio.gq","no entries found"),
                ...
                array("id","whois.pandi.id","No match for domain"),
                array("biz.id","whois.pandi.id","No match for domain"),
                array("ac.id", "whois.pandi.id", "No match for domain"),
                array("co.id", "whois.pandi.id", "No match for domain"),
                array("net.id", "whois.pandi.id", "No match for domain"),
                array("or.id", "whois.pandi.id", "No match for domain"),
                array("web.id", "whois.pandi.id", "No match for domain"),
                array("sch.id", "whois.pandi.id", "No match for domain"),
                array("mil.id", "whois.pandi.id", "No match for domain"),
                array("go.id", "whois.pandi.id", "No match for domain"),
                ...
                array("ml","whois.dot.ml","Invalid query"),
                ...
                array("tk","whois.dot.tk","Invalid query"),
