...
class Registrar_Adapter_Moniker extends Registrar_AdapterAbstract
{
    ...
    public function __construct($options)
    {
        if (isset($options['apikey']) && !empty($options['apikey'])) {
            ...
            throw new Registrar_Exception('The ":domain_registrar" domain registrar is not fully configured. Please configure the :missing', [':domain_registrar' => self::$brand, ':missing' => self::$brand . ' API key'], 3001);
        }
        ...
        if (isset($options['password']) && !empty($options['password'])) {
            ...
            throw new Registrar_Exception('The ":domain_registrar" domain registrar is not fully configured. Please configure the :missing', [':domain_registrar' => self::$brand, ':missing' => self::$brand . ' API password'], 3001);
        }
    }
    ...
    public function getDomainDetails(Registrar_Domain $domain)
    {
        ...
        if ($result['status'] == 'SUCCESS') {
            ...
            $placeholders = [':action:' => __trans('get domain details'), ':type:' => self::$brand];
    ...
    {
        throw new Registrar_Exception(':type: does not support :action:', [':type:' => self::$brand, ':action:' => __trans('deleting domains')]);
    }
