 ...
 */
class Registrar_Exception extends FOSSBilling\Exception\BaseException
{
    /**
     * Creates a new translated exception, using the FOSSBilling\Exception\BaseException class.
     *
