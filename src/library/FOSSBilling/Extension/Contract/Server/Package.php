...
class Package
{
    ...
    /**
     * Set custom values for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Set a custom value for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Get a custom value from the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Get the name of the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Set the name of the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Get the disk quota of the \FOSSBilling\Extension\Contract\Server\Package instance in MB.
     *
    ...
    /**
     * Set the disk quota of the \FOSSBilling\Extension\Contract\Server\Package instance in MB.
     *
    ...
    /**
     * Get the bandwidth of the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Set the bandwidth of the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Get the maximum number of domains for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Set the maximum number of domains for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Get the maximum number of subdomains for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Set the maximum number of subdomains for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Get the maximum number of parked domains for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Set the maximum number of parked domains for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Get the maximum number of FTP accounts for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Set the maximum number of FTP accounts for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Get the maximum number of SQL databases for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Set the maximum number of SQL databases for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Get the maximum number of POP email accounts for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Set the maximum number of POP email accounts for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Get the maximum quota for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
    ...
    /**
     * Set the maximum quota for the \FOSSBilling\Extension\Contract\Server\Package instance.
     *
