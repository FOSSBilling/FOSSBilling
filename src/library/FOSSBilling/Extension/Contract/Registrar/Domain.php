...
class Domain implements \Stringable
{
    ...
    private ?Domain\Contact $_contact_registrar = null;

    private ?Domain\Contact $_contact_admin = null;

    private ?Domain\Contact $_contact_tech = null;

    private ?Domain\Contact $_contact_billing = null;
    ...
    public function setContactRegistrar(Domain\Contact $c)
    {
    ...
    public function getContactRegistrar(): ?Domain\Contact
    {
        return $this->_contact_registrar;
    }

    public function setContactAdmin(Domain\Contact $c)
    {
    ...
    public function getContactAdmin(): ?Domain\Contact
    {
        return $this->_contact_admin;
    }

    public function setContactTech(Domain\Contact $c)
    {
    ...
    public function getContactTech(): ?Domain\Contact
    {
        return $this->_contact_tech;
    }

    public function setContactBilling(Domain\Contact $c)
    {
    ...
    public function getContactBilling(): ?Domain\Contact
    {
    ...
    public function __toString(): string
    {
        ...
        if ($this->getContactRegistrar() instanceof Domain\Contact) {
            $c .= PHP_EOL;
            $c .= PHP_EOL;
