    ...
    private function getPatches($patchLevel = 0): array
    {
        $patches = [
            ...
            30 => function (): void {
                ...
                $fileActions = [
                    Path::normalize(PATH_VENDOR . '/guzzlehttp') => 'unlink',
                ];
            ...
            31 => function (): void {
                ...
                $fileActions = [
                    Path::normalize(PATH_ROOT . '/htaccess.txt') => 'unlink',
                    Path::normalize(PATH_ROOT . '/config.php.old') => 'unlink',
                ];
                $this->executeFileActions($fileActions);
            },
            32 => function (): void {
                ...
                $fileActions = [
                    Path::normalize(PATH_VENDOR . '/phpmailer') => 'unlink',
                    Path::normalize(PATH_THEMES . '/admin_default/images') => 'unlink',
                    Path::normalize(PATH_THEMES . '/admin_default/assets/scss/bb-deprecated.scss') => 'unlink',
                    Path::normalize(PATH_THEMES . '/admin_default/assets/scss/dataTable-deprecated.scss') => 'unlink',
                    Path::normalize(PATH_THEMES . '/admin_default/assets/scss/main-deprecated.scss') => 'unlink',
                    Path::normalize(PATH_LIBRARY . '/Box/Mail.php') => 'unlink',
                    Path::normalize(PATH_LIBRARY . '/Box/Ftp.php') => 'unlink',
                    Path::normalize(PATH_LIBRARY . '/Box/FileCacheExcption.php') => 'unlink',
                    Path::normalize(PATH_LIBRARY . '/Box/Zip.php') => 'unlink',
                    Path::normalize(PATH_LIBRARY . '/Box/Requirements.php') => 'unlink',
                    Path::normalize(PATH_LIBRARY . '/Box/Version.php') => 'unlink',
                    Path::normalize(PATH_LIBRARY . '/Box/Extension.php') => 'unlink',
                    Path::normalize(PATH_LIBRARY . '/Box/Cookie.php') => 'unlink',
                    Path::normalize(PATH_LIBRARY . '/Box/ExceptionAuth.php') => 'unlink',
                    Path::normalize(PATH_LIBRARY . '/Box/Response.php') => 'unlink',
                    Path::normalize(PATH_LIBRARY . '/Box/Config.php') => 'unlink',
                ];
                $this->executeFileActions($fileActions);
            },
            33 => function (): void {
                ...
                $fileActions = [
                    Path::normalize(PATH_LIBRARY . '/FileCache.php') => 'unlink',
                ];
                $this->executeFileActions($fileActions);
            },
            34 => function (): void {
            ...
            36 => function (): void {
                ...
                $fileActions = [
                    Path::normalize(PATH_MODS . '/Kb') => 'unlink',
                ];
                $this->executeFileActions($fileActions);
            },
            37 => function (): void {
                ...
                $fileActions = [
                    Path::normalize(PATH_MODS . '/Queue') => 'unlink',
                ];
                $this->executeFileActions($fileActions);
            },
            38 => function (): void {
