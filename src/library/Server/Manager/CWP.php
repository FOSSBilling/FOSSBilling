...
class Server_Manager_CWP extends Server_Manager
{
    ...
    public function init(): void
    {
        ...
        $this->_config['port'] = FOSSBilling\Core\Utils\Normalizer::normalizePort($this->_config['port'] ?? null, 2304);
    }
    ...
    public function synchronizeAccount(Server_Account $account): Server_Account
    {
        ...
        $new->setReseller(FOSSBilling\Core\Utils\Normalizer::normalizeBoolean($acc['account_info']['reseller'] ?? false));
