    ...
    protected function convertCacheWriteFailure(\RuntimeException $e): never
    {
        ...
        foreach ($cacheWriteFailurePrefixes as $prefix) {
            if (str_starts_with($e->getMessage(), $prefix)) {
                ...
                throw new \FOSSBilling\Core\Exception\InformationException('The template cache directory could not be written to. Please check the file permissions and available disk space for the "data/cache" directory.', null, 5002);
            }
        }
