...
/* partial_menu.phtml */
class __TwigTemplate_f6fdf3a9d57b9bb99f750daeab11a9dbe0219993f3dbfa051ff530f5a9b515d4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% for location,group in navigation %}
    ...
    {% endif %}
{% endfor %}
</ul>", "partial_menu.phtml", "/var/www/vhosts/webbhostingservices.com/httpdocs/boxbilling/bb-themes/admin_default/html/partial_menu.phtml");
    }
}
