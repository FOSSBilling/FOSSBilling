...
class __TwigTemplate_744f044322c2c43c1ff4d58977fb4d7e535b18183511472a3bd2e166e3283e69 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% set rc = guest.spamchecker_recaptcha %}
    ...
    {% endif %}
{% endif %}
{% endmacro %}", "macro_functions.phtml", "/var/www/vhosts/webbhostingservices.com/httpdocs/boxbilling/bb-themes/huraga/html/macro_functions.phtml");
    }
}
