...
# FOSSBilling installer (Laravel edition)
# This script installs FOSSBilling Laravel using Docker Compose
#
...
# Won't work with the Laravel branch yet. Just copied here to start working on it.

INSTALLER_VERSION="v1.0.0 (Laravel)"
