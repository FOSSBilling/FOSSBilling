...
class __TwigTemplate_1e4b103377ac20af91cda1f04b4b0d21e6453dd4aad758ce34214c5e1c159d5e extends Template
{
    private $source;
    private $macros = [];
    ...
    {% endfor %}
{% endfor %}", "partial_message.phtml", "/shared/httpd/up-boxbilling/FOSSBilling/src/bb-themes/boxbilling/html/partial_message.phtml");
    }
}
