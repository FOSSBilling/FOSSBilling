...
/* partial_menu.phtml */
class __TwigTemplate_0fac514619d8e0dfe0c086d7423aabc95f30077aed7547cc85fc790785786fc8 extends Template
{
    private $source;
    private $macros = [];
...
{% for location,group in navigation %}
    ...
    {% endif %}
{% endfor %}
</ul>", "partial_menu.phtml", "/shared/httpd/up-boxbilling/FOSSBilling/src/bb-themes/admin_default/html/partial_menu.phtml");
    }
}
